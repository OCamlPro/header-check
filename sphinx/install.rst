...
If :code:`header-check` is available in your opam repository, you can just call::

  opam install header-check

Build and install with :code:`dune`
-----------------------------------

Checkout the sources of :code:`header-check` in a directory.
