...
# -*- coding: utf-8 -*-
#
# header-check documentation build configuration file, created by
# sphinx-quickstart.
#
...
latex_documents = [
    (master_doc, 'header-check.tex', 'header-check Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'header-check', 'header-check Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'header-check', 'header-check Documentation',
     author, 'header-check', 'One line description of project.',
     'Miscellaneous'),
]
